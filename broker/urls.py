...
urlpatterns = [
    ...
    path ('bitcoin_payout/', views.bitcoin_payout, name = "bitcoin_payout"),
    path ('wire_transfer_payout/', views.wire_transfer_payout, name = "wire_transfer_payout"),
    path ('bank_transfer_payout/', views.bank_transfer_payout, name = "bank_transfer_payout"),
 ]